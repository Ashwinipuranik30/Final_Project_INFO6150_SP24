        ...
        <section className="bg-white">
              <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-gray-800 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                    <h2 className="text-white text-3xl font-extrabold mb-2">Mission</h2>
                    <p className="text-lg font-normal text-gray-100 dark:text-gray-400 mb-4 py-4">Our mission at Tripinn is to inspire and empower individuals to explore the world by providing exceptional travel experiences tailored to their unique interests and preferences. We strive to create unforgettable memories, foster cultural understanding, and promote sustainable travel practices. With our expertise, personalized service, and commitment to excellence, we aim to be the trusted partner for all our clients' travel needs, ensuring every journey is filled with adventure, discovery, and joy.</p>
                  </div>
                  <div className="bg-gray-800 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                    <h2 className="text-white text-3xl font-extrabold mb-2">Vision</h2>
                    <p className="ext-lg font-normal text-gray-100 dark:text-gray-400 mb-4 py-4">Our vision is to inspire and enable people to explore the world by providing exceptional travel experiences that exceed expectations. We aim to be the preferred choice for travelers seeking personalized, immersive, and unforgettable journeys. Through innovation, integrity, and a commitment to excellence, we strive to create lifelong memories and foster a deeper appreciation for the diverse cultures and natural wonders of our planet.</p>
                  </div>
                </div>
              </div>
            </section>
